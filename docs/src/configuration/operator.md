...
The operator accepts command line arguments to override some of the default behaviours.
...
| `--leader-elect` | boolean | Enable leader election for controller manager. Optional for single replica | `true` |
